...
const KICKER_ICONS: [RegExp, LucideIcon][] = [
  [/zakat|donat|giv|sadaqah|amount|fund|contributor|pledge/i, HandHeart],
  ...
  [/account|transparen|money|spend|ledger|verified|figure|reconcil|total/i, Scale],
  ...
  [/teacher|founder|trustee|family|people|organisation|structure|who|about|your information|your detail/i, Users],
  ...
  [/impact|result|done|report|year|flagship|programme/i, BarChart3],
