...
/** The 2025 headline is verified (docs/11); the written report is still being prepared. */
export default function Impact2025Page() {
  return (
    <ComingSoon
      ...
      pending="The full 2025 report is being written up. The headline figure, the category breakdown and the overheads are verified and published on the impact page in the meantime."
