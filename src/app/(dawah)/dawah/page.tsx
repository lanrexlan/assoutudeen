  ...
  return (
    <>
      <section className="relative overflow-hidden bg-ink text-chalk">
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute left-1/2 top-0 h-96 w-[44rem] -translate-x-1/2 rounded-b-full bg-[radial-gradient(ellipse_at_top,rgba(224,160,106,0.16),transparent_65%)]"
        />
        <Container className="relative py-16 text-center sm:py-24">
          <div className="mx-auto max-w-3xl">
            <Kicker align="center" tone="dark">Assoutudeen Dawah Institute</Kicker>
